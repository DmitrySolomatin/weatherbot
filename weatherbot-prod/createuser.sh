...
#create database
sudo -u postgres bash -c "psql -c\"CREATE DATABASE weatherbot-prod;\""
...
sudo -u postgres bash -c "psql -c \"GRANT ALL PRIVILEGES ON DATABASE weatherbot-prod to weather_admin;\""
